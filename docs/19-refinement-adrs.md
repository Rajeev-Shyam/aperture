...
**Status:** [DECIDED] R2 (Q31, Q34, Q38, Q45) — **the 7.0 GB figure amended by owner decision #43 (Doc 24, 2026-08-16): the ceiling is derived at startup as `GPU total − 1.0 GB`, clamped [2.0, 31.0], with 7.0 as the fallback. Identical on the 8 GB dev machine; see Doc 04's 2026-08-19 status section.** The invariant itself — a hard admission bound no load or job may exceed — is unchanged. **Amends:** Doc 04 R1/R3, §3–§4; Doc 12 §4; Doc 18 §4.
